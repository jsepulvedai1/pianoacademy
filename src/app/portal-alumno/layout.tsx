...
import { Music, LayoutDashboard, MessageCircle, LogOut, FileText, CreditCard, ShoppingBag } from "lucide-react";
...
export default function StudentLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    { href: "/portal-alumno/dashboard", label: "Mi Resumen", icon: LayoutDashboard },
    { href: "/portal-alumno/wall", label: "Muro Académico", icon: MessageCircle },
    { href: "/portal-alumno/shop", label: "Planes Académicos", icon: ShoppingBag },
  ];
